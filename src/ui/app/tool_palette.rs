        ...
        let panel =
            egui::SidePanel::left("tools")
                ...
                .show(ctx, |ui: &mut egui::Ui| {
                    ...
                    // List of tools available from the palette.  The Edit tool is once again
                    // available for users who need to switch to editing mode directly.
                    // Each entry consists of the tool variant, an icon, and a label.
